  ...
  return (
    <div className='WelcomeBody'>
      <div className="cardWelcomePage">
        ...
        <input type="button" value="Join A Room" className='CreateARoomButn mt-4' />
        <span className='my-1'>Or</span>
        <input type="button" value="Create A Room" onClick={()=> navigateTo("/create-room")} className='CreateARoomButn' />
      </div>
    </div>
  )
}
